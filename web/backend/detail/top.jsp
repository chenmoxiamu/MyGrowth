...
<c:set var="ctx" value="${pageContext.request.contextPath}/backend/detail" scope="application"/>
...
<body>
	...
	<div id="Head_1">
		...
		<div id="Head_1_UserWelcome">
			...
			<c:if test="${empty loginAdmin}">您好，<b>管理员</b></c:if>
			<c:if test="${not empty loginAdmin}">您好，<b>${loginAdmin.adminName}</b></c:if>
		</div>
		<!-- 一些链接按钮 -->
		<div id="Head_1_FunctionButton">
			<a target="right" href="/admin?method=logOut">
				<img width="78" height="20" src="style/images/help2.gif" />
			</a>
			<a target="_parent" href="/admin?method=logOut">
